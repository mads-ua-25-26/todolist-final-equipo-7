...
public class UsuarioServiceTest {
    ...
    public void testAllUsuarios() {
        // GIVEN
        // Tres usuarios en la base de datos
        ...
        // THEN
        // se devuelven los tres usuarios
        assertThat(usuarios).hasSize(3);
        assertThat(usuarios).extracting("email")
                .containsExactlyInAnyOrder("ana@gmail.com", "pedro@gmail.com", "maria@gmail.com");
    }
    @Test
    public void testAllUsuariosVacio() {
        // GIVEN
        // Base de datos vacía (por el @Sql clean-db.sql)
